  ...
  return (
    <div>
      ...
      <div className="relative h-64 md:h-80 overflow-hidden">
        <img
          src={toAbsoluteBannerUrl(store.bannerImage) || 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200'}
          alt={store.name}
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="base-container py-6 flex items-end gap-5">
            <div className="w-20 h-20 rounded-2xl border-4 border-white overflow-hidden bg-white shadow-xl flex-shrink-0">
              <img src={toAbsoluteLogoUrl(store.logo) || 'https://via.placeholder.com/100'} alt="" className="w-full h-full object-cover" />
            </div>
            <div>
